...
export default function LoadFromPage() {
  ...
  return (
    <Block className="mt-5 mx-auto max-w-4xl">
      <Card colors={{ bgIos: 'bg-figma-bg-card-light dark:bg-figma-bg-card-dark', bgMaterial: 'bg-figma-bg-card-light dark:bg-figma-bg-card-dark' }} raised className='flex items-center flex-col' header={<p className='text-lg'>{t('LoadFromInternet')}</p>}>
        <Link to="/app/internet/" component={RouterLink}>
      ...
      <Card colors={{ bgIos: 'bg-figma-bg-card-light dark:bg-figma-bg-card-dark', bgMaterial: 'bg-figma-bg-card-light dark:bg-figma-bg-card-dark' }} raised className='flex items-center flex-col' header={<p className='text-lg'>{t('LoadFromDevice')}</p>}>
        <Link to="/app/device/" component={RouterLink}>
          <div className={`rounded-full border-2 w-18 h-18 flex justify-center items-center cursor-pointer border-primary text-primary`}>
